...
public class EmployeeJpaModal {
	...
	public EmployeeJpaModal() { }
	
	//parameterized constructor
	public EmployeeJpaModal(int id, String name, String status, int hours, double hourlyRate, double salary) {
		this.employeeId = id;
